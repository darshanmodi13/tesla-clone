...
const ImageComponent = () => {
  return (
    <>
      <div className="relative grid w-full h-[95vh]">
        <Image
          src={img}
          layout="responsive"
          alt="img"
        ...
        <div className="absolute top-0 w-full h-full">
          ...
          <div className="flex justify-center gap-5 text-[14px] absolute bottom-16 w-full max-md:flex-col max-md:items-center">
            <button
              className="bg-btn-bg
